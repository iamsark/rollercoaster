	...
	this.registerEvents = function() {
		...
		$( document ).on( "click", "a.rc-mail-header-quick-action, a.rc-mail-viewer-action", this, function(e) {
			...
			if( $( this ).attr( "data-action" ) == "reply" ) {			
				...
				e.data.controller.viewer.prepareforPrint( _uid, _msgno, _folder );
			} else if( $( this ).attr( "data-action" ) == "move" ) {
				...
				if( _options.length > 0 ) {
					...
					/* Show the dialog box */
					this.controller.dialog.popup( "Where.?", "", "move", fields, buttons, "yes", "medium" );
				}
			} else if( $( this ).attr( "data-action" ) == "flagged" ) {
			...
			if( $( this ).hasClass( "rc-mail-viewer-action" ) && $( this ).attr( "data-action" ) != "reply" ) {
				$( this ).parent().hide();
			}
