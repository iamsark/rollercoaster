var rcViewerView = function( _binder, _parent ) {
	...
	this.renderViewer = function() {
		...
		if( this.binder.header.unseen.toUpperCase() == "U" ) {
			...
			rcControllerObj.folder.fetchFoldersMeta();
			/* Update the 'seen' flag in header on the local cache */
			rcControllerObj.lister.updateFlag( this.binder.fname, this.binder.uid, "seen", true );
		}
	...
	this.renderHeader = function() {		
		...
		this.headerPart += '<div class="rc-mail-viewer-to-block"><span>To</span> : '+ this.getToDetails() +' <button class="rc-header-meta-popup-btn" data-uid="'+ this.binder.uid +'" title="Show Details"><i class="fa fa-caret-down"></i></button></div>';
		...
		this.headerPart += '<a href="#" class="rc-mail-viewer-action" data-msgno="'+ this.binder.msgno +'" data-uid="'+ this.binder.uid +'" data-folder="'+ this.binder.fname +'" data-action="reply-all"><i class="fa fa-mail-reply-all"></i> Reply All</a>';
		this.headerPart += '<a href="#" class="rc-mail-viewer-action" data-msgno="'+ this.binder.msgno +'" data-uid="'+ this.binder.uid +'" data-folder="'+ this.binder.fname +'" data-action="forward"><i class="fa fa-mail-forward"></i> Forward</a>';
		this.headerPart += '<a href="#" class="rc-mail-viewer-action" data-msgno="'+ this.binder.msgno +'" data-uid="'+ this.binder.uid +'" data-folder="'+ this.binder.fname +'" data-action="print"><i class="fa fa-print"></i> Print</a>';
		this.headerPart += '<a href="#" class="rc-mail-viewer-action" data-msgno="'+ this.binder.msgno +'" data-uid="'+ this.binder.uid +'" data-folder="'+ this.binder.fname +'" data-action="delete"><i class="fa fa-trash"></i> Delete</a>';
		this.headerPart += '<a href="#" class="rc-mail-viewer-action" data-msgno="'+ this.binder.msgno +'" data-uid="'+ this.binder.uid +'" data-folder="'+ this.binder.fname +'" data-action="move"><i class="fa fa-exchange"></i> Move</a>';
		this.headerPart += '<a href="#" class="rc-mail-viewer-action" data-msgno="'+ this.binder.msgno +'" data-uid="'+ this.binder.uid +'" data-folder="'+ this.binder.fname +'" data-action="flagged"><i class="fa fa-flag"></i> Flagged</a>';
		this.headerPart += '</div>';
		this.headerPart += '</div>';
