...
if (!class_exists("RC_Helper")) {
	...
	class RC_Helper {
		 ...
		 * 
		 */
		public function strip_unsafe_tags($_html, $_strip_style = false) {
			if ($_html != "") {
				$doc = new DOMDocument();
		 ...
		 * 
		 */
		public function html_to_string($_html, $_strip_style = false) {
			$safe_html = $this->strip_unsafe_tags($_html, $_strip_style);
			/* Remove head tag */
